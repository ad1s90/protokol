...
import static GUI.KnjigaIzlaz.KnjigaIzlazGUI.jTablePrikazKnjigaIzlaz;
 ...
 * @author Home
 */
public class EditKnjigaIzlazGUI extends javax.swing.JDialog {
     ...
     */
    public EditKnjigaIzlazGUI(java.awt.Frame parent, boolean modal) throws IOException, ClassNotFoundException {
        super(parent, modal);
        initComponents();
        tfAdresa.requestFocus();
        KnjigaIzlazDAO db = new KnjigaIzlazDAO();
        int row = jTablePrikazKnjigaIzlaz.getSelectedRow();
        String value = jTablePrikazKnjigaIzlaz.getModel().getValueAt(row, 7).toString();

        KnjigaIzlaz knjigaIzlaz = db.getKI(Integer.valueOf(value));

        Date date = knjigaIzlaz.getDatum_slanja();
        tfRedniBroj.setText(String.valueOf(knjigaIzlaz.getRedni_broj()));
        tfAdresa.setText(knjigaIzlaz.getPrimalac());
        tfOpis.setText(knjigaIzlaz.getOpis());
        tfDatumSlanja.setText(value);
        tfKolicina.setText(String.valueOf(knjigaIzlaz.getKolicina()));
        String vrsta = jComboVrsta.getSelectedItem().toString();
        tfPoslao.setText(knjigaIzlaz.getPoslao());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tfKolicina, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
    ...
    private void btnSnimiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSnimiActionPerformed
        ...
        try {
            ...
            if (!HelpClass.isNum(tfKolicina.getText())) {
            ...
            db.updateKI(id, redniBroj, adresa, opis, date, kolicina, vrsta, poslao);
            ...
            Logger.getLogger(EditKnjigaIzlazGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditKnjigaIzlazGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                EditKnjigaIzlazGUI dialog = new EditKnjigaIzlazGUI(new javax.swing.JFrame(), true);
